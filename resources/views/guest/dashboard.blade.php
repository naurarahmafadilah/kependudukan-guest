        ...
        <div class="container pb-2">
            <div class="d-flex align-items-center justify-content-between">
                ...
                <a href="index.html" class="d-flex align-items-center">
                    <img src="{{ asset('assets-guest/img/kependudukan.jpg') }}" alt="Logo Kependudukan"
                        style="height:55px;">
                </a>
                <div class="d-flex">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    <div class="navbar-nav mx-auto d-flex align-items-center text-center gap-2">
                       ...
                       {{ Request::routeIs('user.*') ? 'text-danger fw-semibold' : 'text-dark' }}">
                        ...
                        <div class="nav-item dropdown">
                            <a href="#"
                                class="nav-link dropdown-toggle stylish-dropdown d-flex align-items-center"
                                data-bs-toggle="dropdown">
                                <img src="https://i.pravatar.cc/40" class="rounded-circle me-1 shadow-sm"
                                    width="34" height="34">
                            ...
                            <div class="row justify-content-start">
                                <div class="col-lg-7 text-start">
                                    ...
                                    <a href="{{ route('guest.pages.about') }}"
                                        class="btn btn-primary py-3 px-5 animated slideInLeft">About Here!</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="container">
                            <div class="row justify-content-end">
                                <div class="col-lg-7 text-end">
                                    ...
                                    <a href="{{ route('kependudukan.index') }}"
                                        class="btn btn-primary py-3 px-5 animated slideInLeft">Explore
                                        More</a>
                                </div>
                            </div>
                        </div>
